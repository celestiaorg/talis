...
// TestDigitalOceanProvider_Basic covers basic provider functionality
func TestDigitalOceanProvider_Basic(t *testing.T) {
	...
	t.Run("NewDigitalOceanProvider_ValidToken", func(t *testing.T) {
	...
	t.Run("NewDigitalOceanProvider_EmptyToken", func(t *testing.T) {
	...
	t.Run("ValidateCredentials_NoClient", func(t *testing.T) {
		provider := &DigitalOceanProvider{}
		err := provider.ValidateCredentials()
		assert.Error(t, err)
...
// TestDigitalOceanProvider_Keys tests the key service functionality
func TestDigitalOceanProvider_Keys(t *testing.T) {
...
// TestDigitalOceanProvider_Droplets tests the droplet service functionality
func TestDigitalOceanProvider_Droplets(t *testing.T) {
...
// Additional tests for CreateInstance and DeleteInstance with mocks
...
func TestCreateMultipleInstancesWithMock(t *testing.T) {
	provider, mockClient := newTestProvider()
